...
x=A.aA(d).a
w=y.u
v=A.a([A.Gx(C.a7,new B.aGB(x),r,r,r,r,r,r,"Print",r,"Enable or disable the entities you want to manage in your factory. Configure details for each enabled entity.","Manage Entities to Track",!0),A.d(r,q.at,r)],w)
for(q=q.Q,u=0;u<12;++u){t=A.a([],w)
if(u>0)t.push(new A.aW(r,q,r,r))
s=D.wJ[u]
t.push(new B.amX(s,!x.f.n(0,s.a),new B.aGC(x,u),new B.aGD(x,u),r))
...
$S:0}
B.aGC.prototype={
$1(d){return this.a.amf(D.wJ[this.b].a,!d)},
$S:3}
B.aGD.prototype={
...
D.bBn=new B.l1("materials","Materials","Manage raw materials, components, and finished goods inventory",C.ey)
