...
x=A.aC(d).a
w=y.e
v=A.a([A.FW(C.ab,new B.aFu(x),r,r,r,r,r,r,"Print",r,"Enable or disable the entities you want to manage in your factory. Configure details for each enabled entity.","Manage Entities to Track",!0),A.h(r,q.z,r)],w)
for(q=q.x,u=0;u<12;++u){t=A.a([],w)
if(u>0)t.push(new A.bc(r,q,r,r))
s=D.wR[u]
t.push(new B.am4(s,!x.f.n(0,s.a),new B.aFv(x,u),new B.aFw(x,u),r))
