...
D.bBo=new B.l2("people","People","Track employees, contractors, and visitors in your factory",C.dF)
D.bBl=new B.l2("machines","Machines","Monitor and manage industrial equipment and machinery",C.iX)
D.bBj=new B.l2("tools","Tools","Track hand tools, measuring equipment, and other instruments",C.iU)
D.bBi=new B.l2("materials","Materials","Manage raw materials, components, and finished goods inventory",C.ey)
D.bBp=new B.l2("workingAreas","Working Areas","Organize departments, floors, zones, and production areas",C.kP)
D.bBh=new B.l2("locations","Locations","Define physical locations and facilities within your factory",C.fM)
D.bBq=new B.l2("devices","Devices","Manage IoT devices, sensors, and connected equipment",C.kR)
D.bBn=new B.l2("clients","Clients","Track client accounts, contacts, and engagement history",C.nW)
D.bBk=new B.l2("workstations","Workstations","Manage operator workstations and shop-floor terminals",C.kQ)
D.bBg=new B.l2("projects","Projects","Plan and track ongoing manufacturing projects and milestones",C.kO)
