...
r=q.d
x=A.h(p,x.Q,p)
return A.a2(p,A.t(A.a([new E.jR(s,t.b,t.c,r,q.e,p),x,new A.cU(C.eu,p,p,A.aD(p,!1,C.G,p,p,!1,"Configure",p,p,r?q.f:p,p,C.a6,p,C.ab,120),p)],y.u),C.v,C.n,C.p,0,C.q),C.y,p,p,new A.ab(o.r,p,u,v,p,p,C.H),p,p,p,p,new A.T(w,w,w,w),p,p,p)}}
B.l2.prototype={}
var z=a.updateTypes([])
B.aFF.prototype={
...
$S:0}
B.aFG.prototype={
$1(d){return this.a.al2(D.wP[this.b].a,!d)},
$S:3}
B.aFH.prototype={
$0(){var x,w=D.wP[this.b],v=this.a.x
if(v!=null){x=y.w
...
D.bBS=new B.l2("people","People","Track employees, contractors, and visitors in your factory",C.dP)
D.bBP=new B.l2("machines","Machines","Monitor and manage industrial equipment and machinery",C.jg)
D.bBN=new B.l2("tools","Tools","Track hand tools, measuring equipment, and other instruments",C.jd)
D.bBM=new B.l2("materials","Materials","Manage raw materials, components, and finished goods inventory",C.eG)
...
D.bBJ=new B.l2("products","Products","Catalog finished products, variants, and SKUs",C.eG)
D.wP=x([D.bBS,D.bBP,D.bBN,D.bBM,D.bBT,D.bBL,D.bBU,D.bBR,D.bBO,D.bBK,D.bBQ,D.bBJ],A.a6("w<l2>"))})()};
(a=>{a["HQU5VSapMWWxo7+3SK7RMsNvOL0="]=a.current})($__dart_deferred_initializers__);