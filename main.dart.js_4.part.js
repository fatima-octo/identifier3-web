...
w(B.aFL,A.iS)
w(B.l1,A.P)})()
A.nV(b.typeUniverse,JSON.parse('{"yA":{"N":[],"d":[],"i":[]},"amh":{"N":[],"d":[],"i":[]}}'))
var y={C:A.a6("ef"),D:A.a6("eA"),u:A.a6("w<d>"),w:A.a6("c"),F:A.a6("ef?"),y:A.a6("eA?")};(function constants(){var x=a.makeConstList
D.bBg=new B.l1("people","People","Track employees, contractors, and visitors in your factory",C.dI)
D.bBd=new B.l1("machines","Machines","Monitor and manage industrial equipment and machinery",C.j_)
D.bBb=new B.l1("tools","Tools","Track hand tools, measuring equipment, and other instruments",C.iX)
D.bBa=new B.l1("materials","Materials","Manage raw materials, components, and finished goods inventory",C.ex)
D.bBh=new B.l1("workingAreas","Working Areas","Organize departments, floors, zones, and production areas",C.kM)
D.bB9=new B.l1("locations","Locations","Define physical locations and facilities within your factory",C.fT)
D.bBi=new B.l1("devices","Devices","Manage IoT devices, sensors, and connected equipment",C.kO)
D.bBf=new B.l1("clients","Clients","Track client accounts, contacts, and engagement history",C.nE)
D.bBc=new B.l1("workstations","Workstations","Manage operator workstations and shop-floor terminals",C.kN)
D.bB8=new B.l1("projects","Projects","Plan and track ongoing manufacturing projects and milestones",C.kL)
