...
$__dart_deferred_initializers__.current=function(a,b,c,$){var B,D,A={EP:function EP(d,e){this.a=d
this.b=e},b5O:function b5O(){},azv:function azv(){},
...
x(A.EP,B.wR)
w(B.P,[A.b5O,A.azv])})()
var y={a:B.a6("K")};(function constants(){C.bDb=new A.azv()
C.bDj=new A.b5O()
C.bDw=new A.EP(0,"platformDefault")
C.aeG=new A.EP(1,"inAppWebView")
C.aeH=new A.EP(2,"inAppBrowserView")
C.Di=new A.EP(3,"externalApplication")
